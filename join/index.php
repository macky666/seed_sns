...
<!-- $_FILESが生成される条件は①enctypeが指定されている②input type="file"がある -->

<!-- ここに元プログラムがあったがメモ帳に移植 -->
        ...
        <form method="post" action="index.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" name="nick_name" class="form-control" placeholder="例： Seed kun" value="<?php echo $nick_name; ?>">
                 ...
                 <p style="color:red;">✴︎　ニックネームを入力してください</p>
                 <?php endif; ?>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <?php if(isset($error['email']) && $error['email'] == 'blank'): ?>
                <p style="color:red;">✴︎　メールアドレスを入力してください</p>
              <?php endif; ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <?php if(isset($error['password']) && $error['password'] == 'blank'): ?>
                <p style="color:red;">✴︎　パスワードを入力してください</p>
              <?php endif; ?>

              <?php if(isset($error['password']) && $error['password'] == 'length'): ?><br>
                <p style="color:red;">✴︎　パスワードは４文字以上で入力してください</p>
              <?php endif; ?>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <?php if(isset($error['picture_path']) && $error['picture_path'] == 'type'): ?><br>
          ...
          <!-- メールアドレス重複チェック -->
          <?php if(isset($error) && $error['email'] == 'duplicate'):?>
