<?php
    ...
    session_start();
    // $_SESSION = array(); 
    // セッションのデバッグでよく使う。セッションの中身を初期化

    require('../dbconnect.php');
    // セッションにデータがなければindex.phpに遷移する
            ...
            <table class="table table-striped table-condensed">
              <tbody>
                ...
                <tr>
                  ...
                  <td><div class="text-center"><img src="../member_picture/<?php echo $_SESSION['join']['picture_path']; ?>" width="100" width="100" height="100"></div></td>
                </tr>
              </tbody>
            </table>
