<?php
    ...
    if(!empty($_GET['search_word'])){
        // 検索の場合
        // sprintf関数とLKE句を組み合わせる場合は、LIKEの％を２回繰り返す必要がある
        ...
        if($_GET['search_column'] == 'all'){
            ...
            $sql = sprintf('SELECT m.`nick_name`, m.`picture_path` , t.* 
                            ...
                            AND t.`tweet` LIKE "%%%s%%"
                            UNION 
                            SELECT m.`nick_name`, m.`picture_path` , t.* 
                            FROM `tweets` t, `members` m
                            WHERE m.`member_id`=t.`member_id`
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
          ...
          <div class="navbar-header page-scroll">
              ...
              <a class="navbar-brand" href="view.php"><span class="strong-title"><i class="fa fa-twitter-square"></i> Seed SNS</span></a>
          </div>
